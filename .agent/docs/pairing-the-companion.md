...
The Modbot companion is a small Windows program that tells your group's Modbot which of the
...
- Install the client ([how](installing-the-companion.md)) and run it once. It sits in the
...
One registry key under your own Windows account, `HKEY_CURRENT_USER\Software\Classes\modbot-companion`,
naming the client's program file as what opens `modbot-companion://` links. It needs no administrator
