...
The Modbot companion is a small Windows program that sits in the tray, reads VRChat's own log
...
[Pairing the companion](pairing-the-companion.md). Pairing takes about ten seconds and
...
the startup entry. The link registry key the client made, `HKEY_CURRENT_USER\Software\Classes\modbot-companion`, is left pointing at a
