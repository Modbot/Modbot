...
**Status:** built, 2026-09-19. Widened the same day (§11–§13): the client now listens for its
**name** first and for a **command** only in the few seconds after it, and the commands are three
rather than one — save a clip, show the overlay, hide the overlay.
...
# Widened the same day: its name first, and two more things to say

**Narrows §5.1** (three words a phrase), **§5.2** (the phrase list), **§6** (what happens when it
fires) and **§10** (two rows come off the list, one goes on).

---

## 11. Its name first, and then what to do
...
### 11.2 What is genuinely new, and what was already true
...
### 11.4 What it costs: the one-breath phrase
...
### 11.5 Rejected: feeding the command matcher all the time and only acting while waiting
...
### 11.6 Rejected: a second copy of the model
...
## 12. Show overlay, hide overlay

### 12.1 The whole list, as pieces
...
### 12.2 How the pieces were produced, and that they were checked
...
### 12.3 Which overlay show and hide act on
...
## 13. Where the new code is, and what is still not built
