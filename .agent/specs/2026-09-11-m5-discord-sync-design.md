...
Treated identically to instance presence: same session model, same time-spent rollups, same 90-day
retention, same purge-user coverage. A community that runs events in Discord voice rather than
