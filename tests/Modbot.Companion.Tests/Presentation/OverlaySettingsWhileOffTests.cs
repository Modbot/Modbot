...
public class OverlaySettingsWhileOffTests
{
    ...
    public void WithNothingSaidTheDefaultIsWhatTheCardShows()
    {
        ...
        Assert.Equal(NotificationSettings.Default, NotificationStatus.None.SettingsOrDefault);
    }
    ...
    public void TheNotificationOverlaysSwitchLivesInItsOwnSettings()
    {
        ...
        var off = NotificationStatus.None with { Settings = NotificationSettings.Default with { On = false } };
    ...
    public void TheSnapshotCarriesBothOverlaysSettingsWhicheverWayTheSwitchesAreSet()
    {
        var state = new CompanionAppState(
            ...
            CompanionSettings.Default with
            {
                ...
                NotifyOverlay = NotificationSettings.Default with { On = false, Spot = ScreenSpot.BottomMiddle },
            })
        {
        ...
        Assert.False(snapshot.NotificationsOrNone.On);
        Assert.Equal(ScreenSpot.BottomMiddle, snapshot.NotificationsOrNone.SettingsOrDefault.Spot);
    }
}
