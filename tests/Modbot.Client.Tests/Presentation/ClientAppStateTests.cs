...
/// </summary>
public class ClientAppStateTests : IDisposable
{
    ...
    private ClientAppState State() => new(_clock, Journal());
    ...
    {
        var journal = Journal();
        var state = new ClientAppState(_clock, journal);
    ...
    private static ClientEvent WireEvent() => new()
    {
        ClientEventId = "e1",
