...
/// <summary>
/// When a moderator is watching a room, and who the room holds while they are and after they stop.
/// </summary>
public class RoomWatchingTests
{
    ...
    private static readonly RoomKey Room = new("wrld_a", "1001");
    ...
    private static RoomPeople Work(DateTimeOffset? closedAt, params PresenceMark[] marks)
        => RoomWatching.Work(Room, marks, Owners, closedAt);
    ...
    [Fact]
    public void TheModeratorTurningUpInAnotherRoom_EndsTheWatch()
    {
    ...
    [Fact]
    public void TheSameNumberInAnotherWorld_IsAnotherRoom()
    {
    ...
    [Fact]
    public void TheRoomClosing_EndsTheWatch()
    {
    ...
    [Fact]
    public void AModeratorSeenBySomebodyElsesClient_IsInTheRoomButNotWatching()
    {
    ...
    [Fact]
    public void AfterAStoppedLogResumes_TheWatchStartsAgainFromTheRestatedRoom()
    {
        var people = Work(null,
        [
            .. AdaArrives(),
