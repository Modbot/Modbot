...
/// <summary>
/// Tells Windows that <c>modbot-client://</c> links open this program.
/// </summary>
/// <remarks>
/// <para><strong>What this writes, and where.</strong> One key under the current user's own
/// registry hive, <c>HKEY_CURRENT_USER\Software\Classes\modbot-client</c>, holding the path of
...
/// <c>modbot-client://</c> link. Without this key the answer is nothing, and the moderator is back
