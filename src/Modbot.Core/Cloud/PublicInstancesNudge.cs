...
/// <summary>
/// A nudge from whatever noticed an instance open or close, so the report is sent then rather than at
...
/// </para>
/// <para>
/// One nudge is one wake-up, not a queue: several instances opening in the same poll are one send.
/// </para>
/// </remarks>
public sealed class PublicInstancesNudge : IDisposable
{
