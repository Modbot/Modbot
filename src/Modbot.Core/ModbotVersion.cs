...
/// </para>
/// </remarks>
public static class ModbotVersion
{
    /// <summary>Calendar version. Generated by the build; this is the development default.</summary>
    public const string Release = "2026.9.0";
