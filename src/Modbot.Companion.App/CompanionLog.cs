...
/// go on. <c>MODBOT_COMPANION_LOG_LEVEL</c> (Verbose, Debug, Information, Warning) turns it down.
/// </para>
/// <para>
...
internal static class CompanionLog
{
    ...
    public static void Start(string appData)
    {
        ...
        var level = Environment.GetEnvironmentVariable("MODBOT_COMPANION_LOG_LEVEL") switch
        {
