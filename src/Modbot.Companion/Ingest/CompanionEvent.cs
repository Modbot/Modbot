...
[JsonConverter(typeof(JsonStringEnumConverter<CompanionEventType>))]
...
public sealed record CompanionEvent
{
    ...
    /// </remarks>
    [JsonPropertyName("companionEventId")]
    public required string CompanionEventId { get; init; }

    [JsonPropertyName("type")]
    public required CompanionEventType Type { get; init; }

    /// <summary>
    /// When it happened, already corrected to the server's clock. For
    /// <see cref="CompanionEventType.InstancePresenceObserved"/> this is the moment the person was
