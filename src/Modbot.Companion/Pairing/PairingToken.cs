...
/// It arrives either inside a <c>modbot-companion://pair?token=…</c> link that Windows hands to the
...
public sealed record PairingToken(Uri Server, string Code)
{
    ...
    public const string Scheme = "modbot-companion";

    /// <summary>What a pairing link starts with. The token follows.</summary>
    public const string LinkPrefix = "modbot-companion://pair?token=";
    ...
    /// <summary>Pulls the token out of <c>modbot-companion://pair?token=…</c>.</summary>
