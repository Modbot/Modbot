...
/// <param name="Metric">The daily total metric name, verbatim, so a chart can be traced to its row.</param>
...
/// <param name="Dimension">The raw daily total dimension, e.g. <c>vrchat:usr_…</c>.</param>
/// <param name="Name">
...
/// <remarks>
/// <para>
/// Spec 5.5: daily totals are never aged out, while facts can be where an operator has configured a
...
/// </para>
/// <para>
/// The gap is not only about retention. Even with nothing pruned, the daily totals series and the fact
