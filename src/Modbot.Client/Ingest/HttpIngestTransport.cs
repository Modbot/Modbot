...
/// </summary>
/// <remarks>
/// <para><strong>This is the only place in the client that transmits observations.</strong> It
/// sends the JSON of an <see cref="EventBatch"/> — whose fields are listed on that type and on
/// <see cref="ClientEvent"/> — to the address the moderator paired with, and nothing else. No
/// telemetry, no crash reports carrying event data, no analytics, and no second destination.</para>
