...
namespace Modbot.Cloud.Data.Migrations
{
    ...
    [Migration("20260926032101_ModbotInstanceBecameServer")]
    partial class ModbotInstanceBecameServer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Modbot.Cloud.Features.ServerAlerts.ServerAlert", b =>
                {
                    b.Property<Guid>("ServerId")
                        .HasColumnType("uuid")
                        .HasColumnName("server_id");
                    ...
                    b.HasKey("ServerId")
                        .HasName("pk_server_alert");

                    b.HasIndex("On")
                        .HasDatabaseName("ix_server_alert_watched");

                    b.ToTable("server_alert", (string)null);
                });
            ...
            modelBuilder.Entity("Modbot.Cloud.Features.Showcase.ShowcaseEntry", b =>
                {
                    ...
                    b.Property<Guid?>("SavedGroupBannerId")
                        .HasColumnType("uuid")
                        .HasColumnName("saved_group_banner_id");

                    b.Property<Guid?>("SavedGroupImageId")
                        .HasColumnType("uuid")
                        .HasColumnName("saved_group_image_id");

                    b.Property<Guid?>("SavedImageId")
                        .HasColumnType("uuid")
                        .HasColumnName("saved_image_id");
            ...
            modelBuilder.Entity("Modbot.Cloud.Features.Showcase.ShowcasePicture", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_showcase_picture");

                    b.ToTable("showcase_picture", (string)null);
                });

            modelBuilder.Entity("Modbot.Cloud.Features.Site.PageServer", b =>
                {
                    ...
                    b.HasKey("ServerUrl")
                        .HasName("pk_page_server");

                    b.HasIndex("LastSeenAt")
                        .HasDatabaseName("ix_page_server_last_seen_at");

                    b.ToTable("page_server", (string)null);
                });

            modelBuilder.Entity("Modbot.Cloud.Features.Site.VisitedServer", b =>
                {
                    b.Property<string>("ServerUrl")
                        .HasMaxLength(2048)
                        .HasColumnType("character varying(2048)")
                    ...
                    b.HasKey("ServerUrl")
                        .HasName("pk_visited_server");

                    b.HasIndex("LastSeenAt")
                        .HasDatabaseName("ix_visited_server_last_seen_at");

                    b.ToTable("visited_server", (string)null);
                });

            modelBuilder.Entity("Modbot.Cloud.Features.Site.VisitorServer", b =>
                {
                    b.Property<string>("IpAddress")
                        .HasMaxLength(45)
                        .HasColumnType("character varying(45)")
                    ...
                    b.HasKey("IpAddress", "ServerUrl")
                        .HasName("pk_visitor_server");

                    b.HasIndex("ServerUrl")
                        .HasDatabaseName("ix_visitor_server_server_url");

                    b.ToTable("visitor_server", (string)null);
                });
