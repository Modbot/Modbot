...
/// <summary>
/// The key that reads the public instances feed, from <c>INSTANCES_API_KEY</c>.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// </remarks>
public sealed class InstancesApiKey
{
    ...
    public InstancesApiKey(string? key, RootApiKey root)
    {
